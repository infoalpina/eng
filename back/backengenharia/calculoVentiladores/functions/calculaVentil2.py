...
def calculaVentil2(dados):
    serie = dados['received_data']['datas'][0]['outros_dados'][1]['serie']

    if serie == '8E' or serie == '9EM2':
        try:
            densidade = float(dados['received_data']['R1'])
            vazao_volumetrica_por_torre = float(
                dados['received_data']['vazao_volumetrica_de_ar_por_torre'])
            AlturaDoDifusor = float(dados['received_data']['AlturaDoDifusor'])
            perda_pressao_estatica_do_ar = float(dados['received_data']['Y5'])
            perda_pressao_estatica_do_ar_em_pascal = perda_pressao_estatica_do_ar*9.8066
            database = dados['received_data']['datas']
            outros_dados = dados['received_data']['datas'][0]['outros_dados']
            database = database[0]
            ...
            return [{
                ...
                'nome': dados['received_data']['datas'][0]['outros_dados'][1]['modelo'],
                'empuxo': empuxo,
        ...
        A0 = dados['received_data']['datas'][0]['outros_dados'][1]['A0']
        A1 = dados['received_data']['datas'][0]['outros_dados'][1]['A1']
        A2 = dados['received_data']['datas'][0]['outros_dados'][1]['A2']
        A3 = dados['received_data']['datas'][0]['outros_dados'][1]['A3']
        vazao_volumetrica_de_ar_por_torre = dados['received_data']['vazao_volumetrica_de_ar_por_torre']
        perda_pressao_estatica_do_ar = (vazao_volumetrica_de_ar_por_torre**3)*A0 + (
            vazao_volumetrica_de_ar_por_torre**2)*A1 + (vazao_volumetrica_de_ar_por_torre**1)*A2+A3
        perda_pressao_estatica_do_ar_em_pascal = perda_pressao_estatica_do_ar*9.8066
