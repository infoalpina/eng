...
def calculoSelecao(dados, K8=0, F8=0, H9=0):
    ...
    print('selecao_dados_principais', len(selecao_dados_principais))
    '''print('selecao_pilaretes', selecao_pilaretes)
    print('selecao_camadas_de_enchimento', selecao_camadas_de_enchimento)
    print('chars_torre', chars_torre)
    print('chars_enchimento', chars_enchimento)
    print('chars_mote_vent', chars_mote_vent)
    print('chars_camadas_de_enchimento', chars_camadas_de_enchimento)'''
    ...
    for N2 in range(NumeroDeCelulasMinimo, NumeroDeCelulasMaximo):
        if K1 == 31:
            K1 = 12
        if K1 == 32:
            K1 = 22
        ...
        while True:
            ...
            if I8 == 0:
                print('teste 1')
                for J9 in range(contagem):
                    W = W0
                    if F0 == S[J9][2]:
                        F = F0
                        return_770 = analise_770(G0, F, W, R1, M0, N2, H1, C0, P0, K8, L3,
                                                 F8, I3, K, J9, N1, H, A, I8, D6, S, K1, Z, L2, T1, T2, D1, Fdata)
                        if return_770 == 200:
                            repeat_550 = 1
            else:
                print('teste 2')
                ...
                while repeat_550 == 0:
                    ...
                    I3 = 0
                    J9 = J9+I7
                    '''J9 max deve ser o valor de len(quantidade de torres posiveis)'''
                    if J9 < contagem or J9 >= 0:
                        ...
                        if R > R8:
                            return_770 = analise_770(G0, F, W, R1, M0, N2, H1, C0, P0, K8, L3, F8, I3, K, J9, N1, H, A,
                                                     I8, D6, S, K1, Z, L2, T1, T2, D1, Fdata)
                            if return_770 == 200:
                                repeat_550 = 1
                    else:
                        repeat_550 = 1
